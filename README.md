...
2. 마법사 상어와 비바라기 (골드5) https://www.acmicpc.net/problem/21610
   > 프로그래머스
3. 주식 가격 (Lv.2) https://programmers.co.kr/learn/courses/30/lessons/42584
...
### 참고사항 : 1살 먹은 오합지졸 스터디~~ 연말 잘보내고 와요~
...
### 스터디 : 2/21 오후 10시 (디스코드)

### 참고사항 : 공통프로젝트 최종발표 기간이니 싸피인들 힘내세요~!
